    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception
    {
        http.csrf().disable()
               ...
               /* .authorizeHttpRequests()
                ...
                .requestMatchers(HttpMethod.POST,"/api/addmotor/**").hasAuthority("ADMIN")
                .requestMatchers(HttpMethod.PUT,"/api/updatemotor/**").hasAuthority("ADMIN")
                .requestMatchers(HttpMethod.DELETE,"/api/delmotor/**").hasAuthority("ADMIN")
                .requestMatchers("/typ/**").hasAnyAuthority("ADMIN","USER")
